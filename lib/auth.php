...
/** Used by AJAX-style endpoints (admin/api/*.php). Plain pages render HTML directly. */
...
/** For plain HTML admin pages — redirects to login instead of a JSON 401. */
...
function admin_url($path = '') {
  ...
  // Normalise so this works whether the current script is admin/foo.php or admin/sub/foo.php.
  if (basename($dir) !== 'admin' && strpos($dir, '/admin') !== false) {
    $dir = substr($dir, 0, strpos($dir, '/admin') + 6);
  }
