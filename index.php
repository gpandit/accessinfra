...
const T = {
  ...
  kn: {
    ...
    activities:[
      { num:'01', accent:'#FFC100', subtitle:'ಸ್ಥಾನ ನಿರ್ಣಯ ಮತ್ತು ಹೊಂದಾಣಿಕೆ', title:'ಪ್ಲೇಸ್‌ಮೆಂಟ್ ಸಲಹೆ', desc:'ನಿಮ್ಮ ಉತ್ಪನ್ನ ಮತ್ತು ಸೇವಾ ಕೊಡುಗೆಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಿ ಸೂಕ್ತ ಸರ್ಕಾರಿ ಇಲಾಖೆಗಳನ್ನು ಗುರುತಿಸುತ್ತೇವೆ.', points:['ಇಲಾಖೆ ಮತ್ತು ಯೋಜನೆ ಹೊಂದಾಣಿಕೆ ವಿಶ್ಲೇಷಣೆ','ಸ್ಪರ್ಧಾತ್ಮಕ ಭೂದೃಶ್ಯ ನಕ್ಷೆ','ಮಧ್ಯಸ್ಥಗಾರ ಜೋಡಣೆ ತಂತ್ರ','ಪ್ರವೇಶ ಬಿಂದು ಗುರುತಿಸುವಿಕೆ'] },
      { num:'02', accent:'#F5D000', subtitle:'ಅರ್ಹತೆ ಮತ್ತು ಅನುಸರಣೆ ತಪಾಸಣೆ', title:'ಟೆಂಡರ್ ಅರ್ಹತಾ ಸಲಹೆ', desc:'ಸಂಪನ್ಮೂಲ ತೊಡಗಿಸುವ ಮೊದಲು ನಿಮ್ಮ ಕಂಪನಿ ನಿರ್ದಿಷ್ಟ ಟೆಂಡರ್‌ಗೆ ಅರ್ಹವೇ ಎಂದು ಮೌಲ್ಯಮಾಪನ ಮಾಡುತ್ತೇವೆ.', points:['ಅರ್ಹತಾ ಮಾನದಂಡ ಪರಿಶೀಲನೆ','ವಹಿವಾಟು ಮತ್ತು ನಿವ್ವಳ ಮೌಲ್ಯ ತಪಾಸಣೆ','ತಾಂತ್ರಿಕ ಅರ್ಹತಾ ಅಂತರ','ಬಿಡ್-ಪೂರ್ವ ಪ್ರಶ್ನೆ ಬೆಂಬಲ'] },
      { num:'03', accent:'#FFC100', subtitle:'ಸಂಪೂರ್ಣ ಬಿಡ್ ನಿರ್ವಹಣೆ', title:'ಟೆಂಡರ್ ಡ್ರಾಫ್ಟಿಂಗ್ ಸೇವೆ', desc:'PQ/RFQ ಪ್ರತಿಕ್ರಿಯೆಗಳಿಂದ ಸಂಪೂರ್ಣ ತಾಂತ್ರಿಕ ಪ್ರಸ್ತಾವಗಳವರೆಗೆ ಬಲವಾದ ಬಿಡ್ ದಾಖಲೆಗಳನ್ನು ತಯಾರಿಸುತ್ತೇವೆ.', points:['ಪೂರ್ವ-ಅರ್ಹತಾ ದಾಖಲೆಗಳು','ತಾಂತ್ರಿಕ ಮತ್ತು ವಾಣಿಜ್ಯ ಬಿಡ್‌ಗಳು','BoQ ರಚನೆ','ಅನುಸರಣಾ ಪಟ್ಟಿ ಮತ್ತು ಪರಿಶೀಲನೆ'] },
      { num:'04', accent:'#F5D000', subtitle:'ಅಡ್ಜ್ಯೂಡಿಕೇಷನ್ ನಂತರ ನಿರಂತರ ಸಲಹೆ', title:'ಪ್ರಾಜೆಕ್ಟ್ ಜೀವನಚಕ್ರ ಬೆಂಬಲ', desc:'ಗೆಲ್ಲುವುದು ಮಾತ್ರ ಆರಂಭ. ಮೈಲ್‌ಸ್ಟೋನ್ ಪಾವತಿ ಮತ್ತು ವಿವಾದ ಪರಿಹಾರದಲ್ಲಿ ನಿಮ್ಮ ಜೊತೆ ನಿಲ್ಲುತ್ತೇವೆ.', points:['ಮೈಲ್‌ಸ್ಟೋನ್ ಪಾವತಿ ಸೌಲಭ್ಯ','ದೂರು ಪರಿಹಾರ','ವ್ಯತ್ಯಾಸ ಆದೇಶ ನಿರ್ವಹಣೆ','ಇಲಾಖಾ ಸಂಪರ್ಕ ಬೆಂಬಲ'] },
      { num:'05', accent:'#FFC100', subtitle:'ಪ್ರಾಕ್ಟಿವ್ ಪ್ರಸ್ತಾವ ಅಭಿವೃದ್ಧಿ', title:'ಹೊಸ ಪ್ರಾಜೆಕ್ಟ್ ವಿಚಾರ ಮಂಥನ', desc:'ಟೆಂಡರ್ ಜಾರಿಗೆ ಬರುವ ಮೊದಲೇ ಸರಿಯಾದ ಅಧಿಕಾರಿಗಳೊಂದಿಗೆ ಸಂಪರ್ಕ ಕಲ್ಪಿಸುತ್ತೇವೆ.', points:['ಅವಕಾಶ ಮಂಥನ ಸೆಶನ್‌ಗಳು','ಸ್ವಯಂಪ್ರೇರಿತ ಪ್ರಸ್ತಾವ ರಚನೆ','ಉತ್ಪನ್ನ-ಯೋಜನೆ ಹೊಂದಾಣಿಕೆ','ಅಧಿಕಾರಿ ಪರಿಚಯ ಮತ್ತು ಸಭೆಗಳು'] },
    ],
  },
  hi: {
    ...
    activities:[
      { num:'01', accent:'#FFC100', subtitle:'उपयुक्तता मूल्यांकन', title:'प्लेसमेंट परामर्श', desc:'हम विभागों की पहचान करते हैं जहाँ आपके समाधान सबसे अधिक प्रासंगिक होंगे।', points:['विभाग उपयुक्तता विश्लेषण','प्रतिस्पर्धात्मक मानचित्रण','हितधारक रणनीति','प्रवेश बिंदु पहचान'] },
      { num:'02', accent:'#F5D000', subtitle:'पात्रता जाँच', title:'टेंडर योग्यता परामर्श', desc:'संसाधन लगाने से पहले पात्रता का मूल्यांकन।', points:['पात्रता समीक्षा','टर्नओवर जाँच','तकनीकी अंतराल','प्री-बिड सहायता'] },
      { num:'03', accent:'#FFC100', subtitle:'संपूर्ण बिड प्रबंधन', title:'टेंडर ड्राफ्टिंग', desc:'PQ/RFQ से पूर्ण तकनीकी प्रस्तावों तक मजबूत बिड दस्तावेज़।', points:['पूर्व-योग्यता दस्तावेज़','तकनीकी व वाणिज्यिक बिड','BOQ संरचना','अनुपालन समीक्षा'] },
      { num:'04', accent:'#F5D000', subtitle:'पुरस्कार के बाद सहायता', title:'प्रोजेक्ट लाइफसाइकिल', desc:'जीतना शुरुआत है — डिलीवरी तक हम साथ हैं।', points:['मील भुगतान','शिकायत समाधान','वेरिएशन प्रबंधन','विभागीय संपर्क'] },
      { num:'05', accent:'#FFC100', subtitle:'सक्रिय प्रस्ताव विकास', title:'नई परियोजना विचार', desc:'टेंडर से पहले अधिकारियों से परिचय।', points:['विचार-मंथन','अनचाहे प्रस्ताव','उत्पाद-योजना मिलान','अधिकारी परिचय'] },
    ],
  },
  te: {
    ...
    activities:[
      { num:'01', accent:'#FFC100', subtitle:'అనుకూలత అంచనా', title:'ప్లేస్‌మెంట్ అడ్వైజరీ', desc:'మీ పరిష్కారాలకు అనువైన శాఖలను గుర్తిస్తాం.', points:['శాఖ అనుకూలత','పోటీ మ్యాపింగ్','వాటాదారుల వ్యూహం','ప్రవేశ బిందువు'] },
      { num:'02', accent:'#F5D000', subtitle:'అర్హత తనిఖీలు', title:'టెండర్ అర్హతా అడ్వైజరీ', desc:'వనరులు పెట్టుబడి పెట్టే ముందు అర్హత అంచనా.', points:['అర్హతా సమీక్ష','టర్నోవర్ తనిఖీ','సాంకేతిక అంతరాలు','ప్రి-బిడ్ సహాయం'] },
      { num:'03', accent:'#FFC100', subtitle:'బిడ్ నిర్వహణ', title:'టెండర్ డ్రాఫ్టింగ్', desc:'బలమైన బిడ్ పత్రాలు తయారు చేస్తాం.', points:['ప్రి-క్వాలిఫికేషన్','సాంకేతిక బిడ్‌లు','BOQ నిర్మాణం','సమ్మతి సమీక్ష'] },
      { num:'04', accent:'#F5D000', subtitle:'అవార్డ్ తర్వాత సహాయం', title:'ప్రాజెక్ట్ లైఫ్‌సైకిల్', desc:'గెలవడం కేవలం ప్రారంభం — డెలివరీ వరకు మీతో ఉంటాం.', points:['మైల్‌స్టోన్ చెల్లింపు','ఫిర్యాదు పరిష్కారం','వేరియేషన్ నిర్వహణ','శాఖా సంప్రదింపు'] },
      { num:'05', accent:'#FFC100', subtitle:'ప్రతిపాదన అభివృద్ధి', title:'కొత్త ప్రాజెక్ట్ ఐడియేషన్', desc:'టెండర్ ముందే అధికారులతో పరిచయం.', points:['బ్రెయిన్‌స్టార్మింగ్','అభ్యర్థించని ప్రతిపాదన','ఉత్పత్తి-పథకం మిలాన్','అధికారి పరిచయాలు'] },
    ],
  },
};

const VENDORS = [
  { name:'TechBridge Solutions', abbr:'TB', color:'#FFC100' },
  { name:'NovaSystems',          abbr:'NS', color:'#F5D000' },
  ...
  { name:'Nexalink',             abbr:'NL', color:'#F5D000' },
  { name:'GovTech Hub',          abbr:'GT', color:'#b45309' },
  { name:'SafeNet India',        abbr:'SN', color:'#FFC100' },
    ...
    <nav className="ai-nav" style={{ position:'sticky', top:0, left:0, right:0, zIndex:100, background:'var(--surface)', borderBottom:'1px solid var(--border)', boxShadow:scrolled?'var(--shadow)':'none', backdropFilter:'blur(12px)', transition:'box-shadow 0.3s', padding:'0 clamp(16px,5vw,80px)' }}>
      <div style={{ maxWidth:1280, margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'space-between', height:68 }}>
        ...
        <div className="desktop-nav" style={{ display:'flex', alignItems:'center', gap:2 }}>
          {links.map(l => (
            <a key={l.href} href={l.href} style={{ color:l.active?'#FFC100':'var(--text2)', textDecoration:'none', fontSize:nfs, fontWeight:l.active?700:500, padding:'6px 10px', borderRadius:6, transition:'all 0.15s', background:l.active?'rgba(255,193,0,0.08)':'transparent' }}
        ...
        <div style={{ background:'var(--surface)', borderTop:'1px solid var(--border)', padding:'12px 20px 20px' }}>
          ...
          <div style={{ marginTop:16, paddingTop:14, borderTop:'1px solid var(--border)', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:10 }}>
            <div style={{ display:'flex', gap:4, flexWrap:'wrap' }}>
              {LANGS.map(l => <button key={l.code} onClick={()=>setLang(l.code)} style={{ padding:'5px 10px', borderRadius:6, border:'1.5px solid', borderColor:lang===l.code?'#FFC100':'var(--border)', background:lang===l.code?'rgba(255,193,0,0.1)':'var(--bg2)', color:lang===l.code?'#FFC100':'var(--text2)', fontSize:nfs-1, fontWeight:600, cursor:'pointer' }}>{l.label}</button>)}
            </div>
            <FontSizeBtn fsIdx={fsIdx} cycleFontSize={cycleFontSize} nfs={nfs} />
          </div>
        </div>
    ...
    <section id="top" style={{ minHeight:'78vh', display:'flex', flexDirection:'column', justifyContent:'center', padding:'clamp(100px,12vw,140px) clamp(16px,5vw,80px) 60px', background:'linear-gradient(135deg,#315C2B 0%,#F5D000 55%,#FFC100 100%)', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ maxWidth:1280, margin:'0 auto', width:'100%', position:'relative', zIndex:2 }}>
        ...
        <div style={{ marginTop:36, display:'flex', gap:10, flexWrap:'wrap' }}>
          <a href="#activities" style={{ background:'#fff', color:'#F5D000', textDecoration:'none', padding:'12px 24px', borderRadius:10, fontSize:14, fontWeight:700, boxShadow:'0 4px 20px rgba(49,92,43,0.3)', transition:'transform 0.2s,box-shadow 0.2s' }}
